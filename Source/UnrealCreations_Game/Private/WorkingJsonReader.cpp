...
#include "WorkingJsonReader.h"

// Fill out your copyright notice in the Description page of Project Settings.

#include "JSONReader.h"

UWorkingJsonReader::JSONReader()
{
...
void UWorkingJsonReader::readFile()
{
...
void UWorkingJsonReader::extractScores()
{
...
void UWorkingJsonReader::updateScores(string name, int score)
{
   Score newScore;
   newScore.name = name;
...
void UWorkingJsonReader::printScores() const
{
...
void UWorkingJsonReader::saveScores()
{
...
string UWorkingJsonReader::getName(int rank)
{
...
int UWorkingJsonReader::getScore(int rank)
{
   if (rank >= 0 && rank < scores.size())
